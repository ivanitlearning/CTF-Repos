...
I tried the nmap LDAP enum scripts. The output is pretty long.

```text
root@kali:~/CTF/HTB/Cascade# nmap -Pn -n -sV --script=ldap* 10.10.10.182 -e tun0
Host discovery disabled (-Pn). All addresses will be marked 'up' and scan times will be slower.
Starting Nmap 7.91 ( https://nmap.org ) at 2020-12-06 01:46 +08
Nmap scan report for 10.10.10.182
Host is up (0.0066s latency).
Not shown: 986 filtered ports
PORT      STATE SERVICE       VERSION
53/tcp    open  domain        Microsoft DNS 6.1.7601 (1DB15D39) (Windows Server 2008 R2 SP1)
88/tcp    open  kerberos-sec  Microsoft Windows Kerberos (server time: 2020-12-05 17:46:51Z)
...
|         whenChanged: 2020/12/05 17:21:53 UTC
...
|         creationTime: 132516625132936207
...
But after looking through this I didn't discover anything unusual. Then I tried `ldapsearch`

```text
root@kali:~/CTF/HTB/Cascade# ldapsearch -H ldap://cascade.local:389 -x -b DC=cascade,DC=local
# extended LDIF
#
# LDAPv3
...
badPasswordTime: 0
lastLogoff: 0
lastLogon: 132516649928622924
localPolicyFlags: 0
pwdLastSet: 132516625484248824
primaryGroupID: 516
...
dSCorePropagationData: 20200109154857.0Z
dSCorePropagationData: 16010714223649.0Z
lastLogonTimestamp: 132516625528464067
