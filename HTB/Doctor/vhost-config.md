...
List of vhost config files

```shell
web@doctor ~ $ ls -lah /etc/apache2/sites-available/
total 24K
drwxr-xr-x 2 root root 4,0K Jul 21 19:45 .
drwxr-xr-x 8 root root 4,0K Jul 20 22:32 ..
-rw-r--r-- 1 root root 1,4K Apr 13  2020 000-default.conf
-rw-r--r-- 1 root root  550 Sep 19 16:42 Apache2Proxy.conf
