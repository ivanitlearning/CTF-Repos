...
```text
www-data@FriendZone /etc/apache2/sites-available $ cat 000-default.conf
<VirtualHost *:80>
...
This is the default SSL vhost config

```text
www-data@FriendZone /etc/apache2/sites-available $ cat default-ssl.conf
<IfModule mod_ssl.c>
        <VirtualHost _default_:443>
                ServerAdmin webmaster@localhost
